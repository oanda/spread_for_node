...
function _internalReceive(client, data) {
    ...
    logger.debug("sameEndian: " + sameEndian(serviceType));
    ...
    var groups = [];
    logger.debug("groups: " + numberOfGroups);
...
var SpreadToolkit = function(options) {
    ...
    this.headerBytes = new Buffer(6);
    this.headerOffset = 0;
    this.authBytes = new Buffer(5);
    this.authOffset = 0;
    this.privateGroupLength;
...
//                        this.connectionState = 1;
                ...
                else if (this.authOffset < 5) {
                    this.authBytes[this.authOffset++] = data[i];

                    if (this.authOffset === 5) {
...
//                else if (this.spreadHeaderOffset < 48) {
//                    this.spreadHeaderBytes[this.spreadHeaderOffset++] = data[i];
//
//                    if (this.spreadHeaderOffset === 48) {
//                    }
//                }
